...
// picture
$(".home").css({"background-image": "url('artworks/01_infinity/pics/painting.jpg')", "background-position": "0px -20px"});
$(".symetry").css({"background-image": "url('artworks/01_infinity/pics/painting-invert.jpg')", "background-position": "0px -20px"});
...
$( ".home" ).append("<img src='artworks/01_infinity/pics/crown.gif' style='width : 400px; position:absolute; left:calc(50% - 200px); top:calc(50vh - 200px);'/>");
