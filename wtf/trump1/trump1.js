...
setInterval(function(){ 
    ...
    positionTLx= differenceW/3;
    positionTLy= differenceH/2;
    positionTL = positionTLx+"% " + positionTLy+"%";

    positionTRx= 100 - differenceW/3;
    positionTRy= differenceH/2;
    positionTR = positionTRx+"% " + positionTRy+"%";

    positionBLx= differenceW/3;
    positionBLy= 100 - differenceH/2;
    positionBL = positionBLx+"% " + positionBLy+"%";

    positionBRx= 100 - differenceW/3;
    positionBRy= 100 - differenceH/2;
